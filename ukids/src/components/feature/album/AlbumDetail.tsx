...
const AlbumDetail: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAlbumDetails = async () => {
      try {
        const response = await axios.get(`https://i11b306.p.ssafy.io/api/photo/all/${albumId}`, {
          headers: {
  ...
  return (
    <div className="feature-box relative w-[911px] h-[576px] overflow-x-hidden">
      ...
      <div className=" left-88 top-37 w-[911px] h-[150px] bg-[#fff] z-50">
        ...
        <div className="absolute left-[94px] top-[25px] w-[726px] h-[50px] border-[solid] border-#ddd border border-[0_0_2px] " style={{ textAlign: 'center' }}>
          {/* 제목 아래 실선*/}
          <div
        ...
        <div className="absolute -translate-x-1/2 left-1/2 top-[87px] w-[701px] h-[30px] z-50">
          ...
          <span style={{ fontSize: '20px', color: '#333' }}>{album.date}</span> 
          </div>
      ...
      <div className="photos-container">
          ...
          {album.photos.map((photo, index) => (
            ...
            <div className="photo-imgandcaption">
              ...
              <p dangerouslySetInnerHTML={{ __html: photo.caption }}></p> {/* Here HTML is rendered */}
            </div>
