...
public class GrowthFolderController {
    ...
    public ResponseEntity<Map<String, Object>> createGrowthFolder(@RequestBody GrowthFolderRequestDto growthFolderRequestDto) {
        GrowthFolderResponseDto growthFolderResponseDto = growthFolderService.createGrowthFolder(growthFolderRequestDto);

        return httpResponseUtil.createResponse(HttpMethodCode.POST, growthFolderResponseDto);

    }

    @GetMapping("/all/{familyId}")
    public ResponseEntity<Map<String, Object>> getGrowthFolders(@PathVariable("familyId") Long familyId){
        List<GrowthFolderResponseDto> growthFolders = growthFolderService.getGrowthFolders(familyId);
    ...
    public ResponseEntity<Map<String, Object>> updateGrowthFolder(@PathVariable("folderId") Long folderId,
        ...
        GrowthFolderResponseDto growthFolder = growthFolderService.updateGrowthFolder(growthFolderUpdateRequestDto);

        return httpResponseUtil.createResponse(HttpMethodCode.PUT, growthFolder);
    }
    ...
    public ResponseEntity<Map<String, Object>> deleteGrowthFolder(@PathVariable("folderId") Long folderId){
        ...
        return httpResponseUtil.createResponse(HttpMethodCode.DELETE, SuccessMessage.SUCCESS_DELETE_GROWTHFOLDER);
    }
}
